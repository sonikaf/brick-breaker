...
OFILES = main.o mylib.o text.o font.o welcomeScreen.o winScreen.o lossScreen.o trampoline.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = main.h mylib.h text.h welcomeScreen.h winScreen.h lossScreen.h trampoline.o
